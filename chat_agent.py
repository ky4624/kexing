...
class VideoScriptAgent:
    def __init__(self):
        ...
        self.questions = [
            "我们在推广什么？（例如：某个产品、服务、品牌、活动、APP、课程等）👉 请直接告诉我推广对象。",
            "目标受众是谁？（例如：年轻人、上班族、学生、创业者、家庭用户、游戏玩家等）👉 请描述主要受众人群。",
            "期望的视频情绪或基调是什么？（例如：电影感且鼓舞人心、专业可信、充满科技感、快节奏有冲击力、简约高端等）👉 请告诉我你希望观众看完后的感觉。",
            "偏好的视频风格是？（例如：写实、动画、电影感、未来科技感、极简、高端商业风等）👉 可以选择一种或组合两种风格。",
            "视频语言是什么？（中文 / 英文 / 马来文 / 其他语言）👉 请告诉我你希望视频里的台词 / 字幕使用哪种语言。",
    ...
    def _extract_fields(self, user_input: str) -> Dict[str, Optional[str]]:
        ...
        # 添加简单的关键词提取作为回退
        if not extracted.get("product") and ("app" in user_input.lower() or "应用" in user_input):
            extracted["product"] = user_input
